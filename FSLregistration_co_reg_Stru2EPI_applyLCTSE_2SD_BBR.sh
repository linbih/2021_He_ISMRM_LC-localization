...
do echo ${SUB}
    ...
    fslmaths ${subdir}/${SUB}/Stru2EPI_co_reg/LC_2SD_TEMPLATE_StructSpace_1.nii.gz -mul ${TSE_struct} ${subdir}/${SUB}/Stru2EPI_co_reg/LC_1SD_TEMPLATE_StructSpace_LocalMax_1.nii.gz
    fslmaths ${subdir}/${SUB}/Stru2EPI_co_reg/LC_2SD_TEMPLATE_StructSpace_2.nii.gz -mul ${TSE_struct} ${subdir}/${SUB}/Stru2EPI_co_reg/LC_1SD_TEMPLATE_StructSpace_LocalMax_2.nii.gz
